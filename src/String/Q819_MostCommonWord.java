...
public class Q819_MostCommonWord {
    ...
    public static void main(String[] args){
        ...
        System.out.println(a.mostCommonWord("Bob hit ball a 3 3 3 3 3 3 3 3 ball, the hit BALL flew far after it was hit.",new String [] {"was","hit"}));
    }
    ...
    public String mostCommonWord(String express, String [] banned) {
        ...
        String [] strs=express.toLowerCase().split("[^a-z]+");
